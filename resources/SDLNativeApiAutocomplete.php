 ...
 * @method int SDL_RenderCopyEx(RendererPtr $renderer, TexturePtr $texture, RectPtr|null $srcrect, RectPtr|null $dstrect, float $angle, PointPtr|null $center, int $flip)
 * @method int SDL_RenderCopyExF(RendererPtr $renderer, TexturePtr $texture, RectPtr|null $srcrect, FRectPtr|null $dstrect, float $angle, PointPtr|null $center, int $flip)
 * @method int SDL_RenderCopyF(RendererPtr $renderer, TexturePtr $texture, RectPtr|null $srcrect, FRectPtr|null $dstrect)
