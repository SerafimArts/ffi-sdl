...
interface HintNameInterface
{
     ...
     *    "1" or "overscan"  - Will zoom the rendering so it fills the entire screen, allowing edges to be drawn
     * offscreen
     *
    ...
    /**
     * A variable setting the speed scale for mouse motion, in floating point, when the mouse is not in
     * relative mode
     *
     * @var string
     */
     ...
     * @deprecated Please use @see HintNameInterface::SDL_HINT_MOUSE_TOUCH_EVENTS instead.
     * @deprecated Please use @see HintNameInterface::SDL_HINT_TOUCH_MOUSE_EVENTS instead.
     */
    public const SDL_HINT_ANDROID_SEPARATE_MOUSE_AND_TOUCH = 'SDL_HINT_ANDROID_SEPARATE_MOUSE_AND_TOUCH';
    ...
    /**
     * If set, all devices will be skipped when scanning for game controllers except for the ones listed in
     * this variable.
     *
     * The format of the string is a comma separated list of USB VID/PID pairs
     * in hexadecimal form, e.g.
    ...
    /**
     * A variable that lets you enable joystick (and gamecontroller) events even when your app is in the
     * background.
     *
     * The variable can be set to the following values:
    ...
    /**
     * A variable controlling whether extended input reports should be used for PS4 controllers when using the
     * HIDAPI driver.
     *
     * This variable can be set to the following values:
    ...
    /**
     * A variable that controls whether Steam Controllers should be exposed using the SDL joystick and game
     * controller APIs
     *
     * The variable can be set to the following values:
     ...
     * This variable can be set to the following values:
     *
     *    "ambient"     - Use the AVAudioSessionCategoryAmbient audio category, will be muted by the phone mute switch
     * (default)
