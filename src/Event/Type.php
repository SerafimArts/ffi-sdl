...
interface Type
{
    ...
    public const SDL_LOCALECHANGED = self::SDL_QUIT + 7;
    ...
    public const SDL_TEXTEDITING_EXT = self::SDL_KEYDOWN + 5;
    ...
    public const SDL_JOYBATTERYUPDATED = self::SDL_JOYAXISMOTION + 7;
    ...
    public const SDL_CONTROLLERTOUCHPADDOWN = self::SDL_CONTROLLERAXISMOTION + 6;
    public const SDL_CONTROLLERTOUCHPADMOTION = self::SDL_CONTROLLERAXISMOTION + 7;
    public const SDL_CONTROLLERTOUCHPADUP = self::SDL_CONTROLLERAXISMOTION + 8;
    public const SDL_CONTROLLERSENSORUPDATE = self::SDL_CONTROLLERAXISMOTION + 9;
